    ...
    <>
      <div className="prosjekter">
        ...
        <p>
          ...
          egenhånd i fremtiden. Vi ønsker ikke at de blir avhengige av oss. Mye
          av dette innebærer for eksempel å få barn som ikke har mulighet til å
          betale skolepenger, at vi hjelper dem med dette. Barn som ikke har
          nødvendig skoleutstyr, som for eksempel sekk, skolebøker, blyant,
          riktig uniform. At dette skal bli tilrettelagt for dem slik at de får
          mulighet til skolegang på lik linje med andre barn. Hvis de kommer seg
          gjennom skolen, er sannsynligheten høyere for at de får seg en jobb og
          blir selvstendige videre i livet.
        </p>
      </div>
      <div className="prosjekter2">
        ...
        <p>
          ...
          til arbeidslivet. Vi driver også med familieplanlegging og prevensjon.
          Vi har hatt kurs i familieplanlegging av lokalt helsepersonell, hvor
          det blir gitt ut informasjon, gratis prevensjon og det foregår gratis
          ...
          ta egne valg for seg selv og sitt liv. Noen av våre suksesshistorier
          *link
        </p>
      </div>
    </>
