  ...
  return (
    <>
      ...
      <p>
        ...
        oss, det setter vi ekstremt stor pris på! For å gjøre det litt enklere,
        ønsker vi å samle litt informasjon her for hva du eventuelt kan hjelpe
        oss med.{" "}
      </p>
      ...
      <p>
        ...
        innsamlinger eller andre aktiviteter. - Du ønsker å booke et arrangement
        via oss. Vi har tidligere arrangert veldedighetskonserter,
        veldedighetsyoga, utsalg av hjemmelagde ting, etc. - Privatpersoner som
        ønsker å bli faddere *link, eller månedsgivere. Du velger selv beløp{" "}
      </p>
