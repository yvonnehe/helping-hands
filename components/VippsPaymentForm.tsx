...
const VippsPaymentForm = () => {
    ...
    return (
        <>
            <NextHead
                title="Vipps betaling - Helping Hands"
            ...
            <div className="kontakt">
                <div className="container-fluid">
                    <div className="row kontakt--padding">
                        ...
                        <div className="col-md-6">
                            {/* Additional content, e.g., instructions, image, etc. */}
                        </div>
                    </div>
                </div>
            </div>
...
export default VippsPaymentForm;
